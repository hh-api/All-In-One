...
<ol class="breadcrumbs" itemscope itemtype="http://schema.org/BreadcrumbList">
        ...
        <li class="active">Phim <?php if ($BL=='1') { echo 'Bộ'; } else { echo 'Lẻ'; }?> <?php if ($quoc_gia) echo '/ '.$quoc_gia;?> <?php if ($the_loai) echo '/ '.$the_loai;?> <?php if ($NC) echo '/ '.$NC;?></li>
    </ol>
...
?>
            ...
            <div class="pagination">
                <ul>
<?php if($trang > 3) {?>                        
<li><a href="<?php echo '/z.php?BL='.$BL.'&TL='.$TL.'&QG='.$QG.'&NC='.$NC.'&trang=1'; ?>">1</a></li>
<span>...</span>
<?php } ?>
<?php if($trang > 2) {?>
<li><a href="<?php echo '/z.php?BL='.$BL.'&TL='.$TL.'&QG='.$QG.'&NC='.$NC.'&trang='.($trang - 2); ?>"><?php echo ($trang - 2); ?></a></li>
<?php } ?>
<?php if($trang > 1) {?>
<li><a href="<?php echo '/z.php?BL='.$BL.'&TL='.$TL.'&QG='.$QG.'&NC='.$NC.'&trang='.($trang - 1); ?>"><?php echo ($trang - 1); ?></a></li>
<?php } ?>    
...
<li><a href="<?php echo '/z.php?BL='.$BL.'&TL='.$TL.'&QG='.$QG.'&NC='.$NC.'&trang='.($trang + 3); ?>"><?php echo ($trang + 3); ?></a></li>
<?php } ?>
<span>...</span>
<li><a href="<?php echo '/z.php?BL='.$BL.'&TL='.$TL.'&QG='.$QG.'&NC='.$NC.'&trang='.($sotrang); ?>"><?php echo 'Cuối ('.$sotrang.')'; ?></a></li>
            </ul>
