...
<?php 
$result = mysqli_query($apizophim, "SELECT id,ten_phim,ten_goc,quoc_gia,nam_chieu,thumb,slug,trang_thai FROM phim WHERE `bole`='1' and `the_loai` NOT LIKE '%Hoạt%' order by time DESC limit 12");
...
<li class="item" style="margin: 0 0 0 7px;">
    <span class="label" style="background: darkred; border-bottom: none;"><?php if ((strpos($trang_thai, 'ull') == false)) { echo 'Tập '.$trang_thai; } else { echo $trang_thai; } ?></span>
