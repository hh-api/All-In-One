...
<?php 
$result = mysqli_query($apizophim, "SELECT * FROM phim where ten_phim like '%$s%' or slug like '%$s2%' or dien_vien like '%$s%' or ten_goc like '%$s%' order by time DESC");
...
?>						
						<tr>
							...
							<td>
								<p><?php echo $the_loai;?></p>
							</td>
							<td>
							<a href="/phim/<?php echo $slug; ?>.html" target="_blank"><button class="btn-success" style="margin-bottom:5px">Xem</button></a>
							<br/>
