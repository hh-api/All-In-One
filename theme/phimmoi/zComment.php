...
<link href="/css/comment.css?v=11111121" type='text/css' rel='stylesheet'/>
<style>
...
<div class="comment">
<div id="local_cmt" class="tab-item-cmt" style="display: block;"><div style="color:green; border-bottom:1px solid#ddd;font-weight:700"><?php $count = mysqli_num_rows(mysqli_query($apizophim, "SELECT id FROM comment WHERE `slug` = '$slug'")); echo $count; ?> Bình luận</div>
